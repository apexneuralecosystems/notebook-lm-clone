...
if __name__ == "__main__":
    ...
    if not openrouter_key:
        print("Please set OPEN_ROUTER_API_KEY environment variable")
        exit(1)
    
    generator = PodcastScriptGenerator(openrouter_key)
    ...
    try:
        ...
        # Save to file
        with open("sample_podcast_script.json", "w", encoding='utf-8') as f:
